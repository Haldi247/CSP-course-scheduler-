...
def complete_list():
        ...
        for classes, hasLab in course_details:
            ...
            teacher=classes[1]
            days=classes[2]
            time_start= datetime.strptime(classes[3], "%H:%M").time()
            time_end= datetime.strptime(classes[4], "%H:%M").time()
            code=classes[5]
...
def main():
    ...
    day_start = time(8,30)
    day_end = time(15,45)
    teacher_preference= [("Computer Communication and Networking", "Ms. Tasbiha Fatima", "Mr. M.Waseem Arain"), 
                         ("Pakistan History", "Ms. Parmal Ahmed", "Dr. Moiz Khan"),
                         ("Introduction to Artificial Intelligence", "Dr. Syed Ali Raza", "Ms. Sumaira Saeed", "Dr. Tahir Syed"), 
    ...
    table = timetable.table_generator()
    print()
    if table != None:
